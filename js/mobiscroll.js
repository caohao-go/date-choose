...
(function ($) {
    ...
    var ms = $.mobiscroll,
        ...
        preset = function (inst) {
            console.log("aaaaa 调用 preset 函数(Scoller)", inst)
            var that = $(this),
                format;
            ...
            inst.settings = s;
            console.log("aaaaa preset 函数内 Scoller=", inst)
            ...
            console.log("aaaaa preset 函数内 初始化滚轮 wheels=", wheels)
            ...
            inst.setDate = function (d, fill, time, temp) {
                console.log("aaaaa setDate(d, fill, time, temp)", d, fill, time, temp)
                var i;
                // Set wheels
                for (i in o) {
            ...
            return {
                ...
                headerText: function (v) {
                    console.log("aaaaa headerText(v)", v)
                ...
                */
                formatResult: function (d) {
                    console.log("aaaaa formatResult(d)", d)
                ...
                */
                parseValue: function (val) {
                    console.log("aaaaa return parseValue 调用 ms.parseDate(format, val, setting) 解析日期数据", format, val, s)
                    var d = new Date(),
                        i,
                        result = [];
                    try {
                    ...
                    console.log("aaaaa return parseValue 内日期解析结果(d, o, result)", d, o, result)
                    return result;
                },
                /**
                * check the selected date to be in the minDate / maxDate range and sets unselectable values to disabled
                * @param {Object} dw - jQuery object containing the generated html
                * @param {Integer} [i] - Index of the changed wheel, not set for initial validation
                */
                validate: function (dw, i) {
                    console.log("aaaaa 校验数据(dw, i)", dw, i)
                ...
                methods: {
                    ...
                    */
                    getDate: function (temp) {
                        console.log("aaaaa methods getDate(temp)", temp)
                    ...
                    */
                    setDate: function (d, fill, time, temp) {
                        console.log("aaaaa methods setDate(setDate)", setDate)
                        if (fill == undefined) {
                            fill = false;
                        }
        ...
        console.log("aaaaa ms=", ms);
        console.log("aaaaa date=", date);

    $.each(['datetime'], function (k, v) {
        //预处理
        console.log("aaaaa 预处理，赋值3种格式的 preset 函数: ['date', 'time', 'datetime']", v)
        ms.presets[v] = preset;
    });
    ...
    */
    ms.formatDate = function (format, date, settings) {
        console.log("aaaaa formatDate(format, date, settings)", format, date, settings)
        if (!date) {
            return null;
        }
